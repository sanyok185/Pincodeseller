(() => {
    ...
    document.addEventListener("formSent", (function(e) {
        ...
        myForm.classList.remove("_form-error");
    }));
    let formValidate = {
        getErrors(form) {
            let error = 0;
        ...
        addError(formRequiredItem) {
            ...
            myForm.classList.add("_form-error");
    ...
    da.init();
    const script_myForm = document.querySelector(".contact__form");
    const script_success = document.querySelector(".form__success");
    const script_fail = document.querySelector(".form__fail");
    document.addEventListener("formSent", (function(e) {
        script_success.style.display = "flex";
